...
public function index()
{
    ...
    // Nếu có tìm kiếm hoặc lọc → dùng hàm kết hợp
...
{
    if(!$this->isAdmin()){
        include_once 'app/views/errors/permissionError.php';
    }
    else{
...
public function search() {
    ...
    include_once 'app/views/product/list.php'; // Hoặc trang kết quả tìm kiếm
}
